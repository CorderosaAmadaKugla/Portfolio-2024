...
const Projects = () => {
    ...
    return (
       <div id="Projects" className="p-20 flex flex-col items-center justify-center">
        ...
        <a href="https://www.example.com"><button><img data-aos="fade-down" height={250} width={250} className="flex items-center justify-center rounded-3xl p-1 border-2 border-fuchsia-800 b_glow" src={img2} alt="" /></button></a>
